...
class TSAnnotator:
    """Naive Bayes Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """
    MODEL_NAME = "Naive_Bayes_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Naive Bayes TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Naive Bayes TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Naive Bayes TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Naive Bayes TSAnnotator.
        """
