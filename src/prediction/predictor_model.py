...
class TimeStepClassifier:
    """Naive Bayes TimeStepClassifier.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """
    MODEL_NAME = "Naive_Bayes_TimeStepClassifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Naive Bayes TimeStepClassifier.
    ...
    def build_model(self) -> GaussianNB:
        """Build a new Naive Bayes Classifier."""
        model = GaussianNB(
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Naive Bayes TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the Naive Bayes TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded Naive Bayes TimeStepClassifier.
        """
